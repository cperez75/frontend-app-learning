...
var BROWSER_CLIENT_VERSION = '4.9.4';
var NODE_CLIENT_VERSION = '4.9.4';
...
var enums = /*#__PURE__*/Object.freeze({
    ...
    BROWSER_CLIENT_VERSION: BROWSER_CLIENT_VERSION,
...
var OptimizelyConfig = /** @class */ (function () {
    function OptimizelyConfig(configObj, datafile) {
        ...
        var experimentsMapById = OptimizelyConfig.getExperimentsMapById(configObj, featureIdVariablesMap, variableIdMap);
     ...
     */
    OptimizelyConfig.getExperimentsMapById = function (configObj, featureIdVariableMap, variableIdMap) {
...
var createInstance = function (config) {
    try {
        ...
        var optimizelyOptions = __assign(__assign({ clientEngine: JAVASCRIPT_CLIENT_ENGINE }, config), { eventProcessor: eventProcessor.createEventProcessor(eventProcessorConfig), logger: logger$5,
            errorHandler: errorHandler, datafileManager: config.sdkKey ? createHttpPollingDatafileManager(config.sdkKey, logger$5, config.datafile, config.datafileOptions) : undefined, notificationCenter: notificationCenter, isValidInstance: isValidInstance });
