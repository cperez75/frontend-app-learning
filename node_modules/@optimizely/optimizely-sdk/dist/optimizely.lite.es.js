...
var ForwardingEventProcessor = /** @class */ (function () {
    function ForwardingEventProcessor(dispatcher, notificationSender) {
    ...
    ForwardingEventProcessor.prototype.process = function (event) {
        ...
        if (this.notificationSender) {
            this.notificationSender.sendNotifications(NOTIFICATION_TYPES.LOG_EVENT, formattedEvent);
        }
    };
...
function createForwardingEventProcessor(dispatcher, notificationSender) {
...
var createInstance = function (config) {
    try {
        ...
        var optimizelyOptions = __assign(__assign({ clientEngine: JAVASCRIPT_CLIENT_ENGINE }, config), { logger: logger$5,
            ...
            notificationCenter: notificationCenter, isValidInstance: isValidInstance });
