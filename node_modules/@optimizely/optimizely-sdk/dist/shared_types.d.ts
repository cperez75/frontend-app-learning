...
export declare type NotificationListener<T extends ListenerPayload> = (notificationData: T) => void;
...
export declare type ObjectWithUnknownProperties = {
    [key: string]: unknown;
};
...
export declare type OptimizelyExperimentsMap = {
    [experimentKey: string]: OptimizelyExperiment;
};
export declare type OptimizelyVariablesMap = {
    [variableKey: string]: OptimizelyVariable;
};
export declare type OptimizelyFeaturesMap = {
    [featureKey: string]: OptimizelyFeature;
};
export declare type OptimizelyAttribute = {
    id: string;
    key: string;
};
export declare type OptimizelyAudience = {
    id: string;
    name: string;
    conditions: string;
};
export declare type OptimizelyEvent = {
    id: string;
    key: string;
