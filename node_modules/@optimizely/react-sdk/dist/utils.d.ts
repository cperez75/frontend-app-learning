...
export declare function areUsersEqual(user1: UserInfo, user2: UserInfo): boolean;
...
export declare function createFailedDecision(flagKey: string, message: string, user: UserInfo): OptimizelyDecision;
